...
class Message(object):
    ...
    .message : any
      Can contain information for the caller's use (e.g. a RFC-822 message object).
...
def thread(msglist):
    ...
    # 2. Find root set
    root_set = [ctr for ctr in id_table.values() if ctr.parent is None]
...
def print_container(ctr, depth=0, debug=False):
    import sys
